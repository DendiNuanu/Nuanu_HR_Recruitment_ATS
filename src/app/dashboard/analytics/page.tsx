  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Time to Hire", value: "18 Days", change: "-12%", color: "emerald" },
          { label: "Cost per Hire", value: "$4,200", change: "-5%", color: "blue" },
          { label: "Offer Acceptance", value: "92%", change: "+3%", color: "purple" },
          { label: "Retention Rate", value: "95%", change: "+1%", color: "amber" },
        ].map((stat, i) => (
          <motion.div 
            key={stat.label}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={demoAnalytics.candidateSourceBreakdown} layout="vertical">
        ...
        <div className="card">
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={[
                { month: "Jan", days: 25 }, { month: "Feb", days: 23 },
                { month: "Mar", days: 24 }, { month: "Apr", days: 21 },
                { month: "May", days: 19 }, { month: "Jun", days: 18 }
              ]}>
                <defs>
