...
import { demoAnalytics, demoCandidates, demoInterviews } from "@/lib/demo-data";
...
const statCards = [
  {
    ...
    value: demoAnalytics.activeVacancies,
    total: demoAnalytics.totalVacancies,
    suffix: ` / ${demoAnalytics.totalVacancies}`,
    change: "+3",
    up: true,
    icon: Briefcase,
    color: "emerald",
  ...
  },
  {
    ...
    value: demoAnalytics.totalCandidates,
    change: `+${demoAnalytics.newCandidatesThisMonth}`,
    up: true,
    icon: Users,
    color: "blue",
  ...
  },
  {
    ...
    value: `${demoAnalytics.averageTimeToHire}`,
    suffix: " days",
    change: "-4",
    up: false,
    icon: Clock,
  ...
  },
  {
    ...
    value: `${demoAnalytics.averageMatchScore}`,
    suffix: "%",
    change: "+3%",
    up: true,
    icon: Brain,
  ...
  {
    label: "Cost per Hire",
    value: `$${demoAnalytics.averageCostPerHire.toLocaleString()}`,
    change: "-$350",
    up: false,
    icon: DollarSign,
    color: "red",
    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
        ...
        <motion.div variants={item} className="card lg:col-span-2">
          ...
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={demoAnalytics.pipelineFunnel} barSize={40}>
                ...
                <Bar dataKey="count" radius={[6, 6, 0, 0]}>
                  {demoAnalytics.pipelineFunnel.map((_, index) => (
        ...
        <motion.div variants={item} className="card">
          ...
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  data={demoAnalytics.candidateSourceBreakdown}
                  cx="50%"
                  cy="50%"
                  innerRadius={50}
                  outerRadius={75}
                  ...
                  dataKey="count"
                >
                  {demoAnalytics.candidateSourceBreakdown.map((_, index) => (
          ...
          <div className="space-y-2 mt-2">
            {demoAnalytics.candidateSourceBreakdown.map((source, i) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={item} className="card lg:col-span-2">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={demoAnalytics.monthlyApplications}>
                <defs>
        ...
        <motion.div variants={item} className="card">
          ...
          <div className="flex justify-center mb-4">
            <ScoreCircle score={demoAnalytics.averageMatchScore} size={100} strokeWidth={8} />
          </div>
          <p className="text-center text-xs text-nuanu-gray-400 mb-4">Average Match Score</p>
          <div className="space-y-2">
            {demoAnalytics.matchScoreDistribution.map((dist) => {
              const maxCount = Math.max(...demoAnalytics.matchScoreDistribution.map((d) => d.count));
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <motion.div variants={item} className="card lg:col-span-2">
          ...
          <div className="space-y-3">
            {demoAnalytics.recentActivity.map((activity) => (
        ...
        <motion.div variants={item} className="space-y-6">
          ...
          <div className="card">
            ...
            <div className="space-y-3">
              {demoCandidates.filter((c) => c.score >= 85).slice(0, 4).map((candidate, i) => (
          ...
          <div className="card">
            ...
            <div className="space-y-3">
              {demoInterviews.slice(0, 3).map((interview) => (
