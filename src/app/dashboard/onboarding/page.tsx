...
const mockOnboarding = [
  { id: "o1", candidateName: "David Kim", position: "DevOps Engineer", department: "Engineering", startDate: "2024-05-01", progress: 65, status: "In Progress", tasksCompleted: 13, tasksTotal: 20 },
  { id: "o2", candidateName: "Sarah Jenkins", position: "Marketing Manager", department: "Marketing", startDate: "2024-04-15", progress: 100, status: "Completed", tasksCompleted: 15, tasksTotal: 15 },
  { id: "o3", candidateName: "Michael Chang", position: "Financial Analyst", department: "Finance", startDate: "2024-05-15", progress: 10, status: "Pending", tasksCompleted: 2, tasksTotal: 18 },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="card bg-white p-5 border-l-4 border-l-emerald-500">
          ...
          <p className="text-2xl font-bold text-nuanu-navy">24</p>
        ...
        <div className="card bg-white p-5 border-l-4 border-l-blue-500">
          ...
          <p className="text-2xl font-bold text-nuanu-navy">8</p>
        ...
        <div className="card bg-white p-5 border-l-4 border-l-amber-500">
          ...
          <p className="text-2xl font-bold text-nuanu-navy">3</p>
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          {mockOnboarding.filter(o => o.candidateName.toLowerCase().includes(search.toLowerCase())).map((item, i) => (
            <motion.div
              key={item.id}
