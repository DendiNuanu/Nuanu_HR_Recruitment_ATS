...
const mockAssessments = [
  { id: "a1", title: "Frontend Engineering Test", type: "Technical", duration: "60 mins", candidates: 12, avgScore: 78, status: "Active" },
  { id: "a2", title: "Culture Fit Questionnaire", type: "Behavioral", duration: "15 mins", candidates: 45, avgScore: 85, status: "Active" },
  { id: "a3", title: "Product Management Case", type: "Case Study", duration: "120 mins", candidates: 5, avgScore: 92, status: "Active" },
  { id: "a4", title: "DevOps Infrastructure Task", type: "Technical", duration: "90 mins", candidates: 3, avgScore: 0, status: "Draft" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {mockAssessments.filter(a => a.title.toLowerCase().includes(search.toLowerCase())).map((assessment, i) => (
            <motion.div
              key={assessment.id}
