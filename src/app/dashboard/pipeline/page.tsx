...
export default async function PipelinePage() {
  ...
  applications.forEach(app => {
    ...
    if (formattedCandidates[stage]) {
      formattedCandidates[stage].push({
        ...
        stage: stage,
        tags: app.candidateScore?.overallScore && app.candidateScore.overallScore >= 80 ? ["top_candidate"] : []
      });
    } else {
  ...
  return <PipelineBoard initialCandidates={formattedCandidates} vacancies={vacancies} />;
}
