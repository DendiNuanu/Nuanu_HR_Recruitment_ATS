            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  name="location"
                  type="text"
                  defaultValue={vacancy.location ?? undefined}
                  className="input-field"
                />
              </div>
          ...
          <div className="card space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                name="description"
                rows={8}
                defaultValue={vacancy.description ?? undefined}
                className="input-field"
              ></textarea>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                name="requirements"
                rows={8}
                defaultValue={vacancy.requirements ?? undefined}
                className="input-field"
              ></textarea>
            </div>
          </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="card space-y-6 sticky top-6">
            ...
            <div className="pt-4 border-t border-nuanu-gray-100 space-y-3">
              <button
                type="submit"
                className="w-full btn-primary py-3 justify-center text-sm font-bold shadow-lg shadow-emerald-500/20"
              >
