  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex items-center gap-4">
        <Link
          href="/dashboard/jobs"
          className="p-2 bg-white border border-nuanu-gray-200 rounded-lg hover:bg-nuanu-gray-50 text-nuanu-gray-500 transition-colors"
        >
        ...
        <div>
          ...
          <p className="text-sm text-nuanu-gray-500 mt-1">
            Draft a new job requisition and publish to job boards
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="card space-y-6">
            <h2 className="text-lg font-bold text-nuanu-navy border-b border-nuanu-gray-100 pb-4">
              Job Details
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  name="location"
                  type="text"
                  placeholder="e.g. Remote, On-site (Bali)"
                  className="input-field"
                />
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-nuanu-gray-400 mt-1">
                  Draft jobs are only visible to internal team members
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="card space-y-6 sticky top-6">
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-3 p-3 bg-nuanu-gray-50 rounded-lg border border-nuanu-gray-200 cursor-pointer hover:bg-emerald-50 hover:border-emerald-200 transition-colors">
                ...
                />
                <div>
                  <p className="text-sm font-bold text-nuanu-navy flex items-center gap-2">
                    <LayoutTemplate className="w-4 h-4 text-emerald-500" />{" "}
                    Request Approval & Publish
                  </p>
                  <p className="text-xs text-nuanu-gray-500 mt-1">
                    Submit this vacancy for official approval before publishing.
                  </p>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 p-3 bg-nuanu-gray-50 rounded-lg border border-nuanu-gray-200 cursor-pointer hover:bg-indigo-50 hover:border-indigo-200 transition-colors">
                <input
                  type="checkbox"
                  name="publishJobStreet"
                  className="mt-1 w-4 h-4 text-indigo-600 rounded border-gray-300"
                />
                <div>
                  <p className="text-sm font-bold text-nuanu-navy flex items-center gap-2">
                    <Webhook className="w-4 h-4 text-indigo-500" /> SEEK
                  </p>
                  <p className="text-xs text-nuanu-gray-500 mt-1">
                    Push to SEEK job board via API.
                  </p>
                </div>
              </label>
            </div>
